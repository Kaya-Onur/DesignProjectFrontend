...
class AdvertListBird extends Component {
  state = {
    adverts: [],
    searchCity:""
  };
    ...
    return (
      ...
      <div className="mt-1 ml-5"><p style={{float:"left"}}>Şehire Göre Ara  =   </p><input style={{marginLeft:5}} type="text" placeholder="Şehir yazınız..." onChange={this.onChangeSearch}></input></div>
        ...
        <div class="card-group">{this.state.adverts.filter((advert)=>{
          ...
          if (userRoleId === 1) {
            if (advert.advertStatus && advert.advertType.advertTypeId===3) {
              return (
                <div className="col-md-4 mr-1" style={{ maxWidth: "350px" }}>
                  <div className="card">
                  <img className="card-img-top" src="https://avatarfiles.alphacoders.com/124/thumb-124746.png" alt="PetPhoto" />
                    ...
                    <li className="list-group-item">
                      ...
                      <li className="list-group-item">
                        <b>Adres: </b>
                        {advert.address.addressDescription+" "+advert.address.neighbourhood.neighbourhoodName+" "+advert.address.district.districtName+"/"+advert.address.city.cityName}
                      </li>
...
export default connect(mapStateToProps)(AdvertListBird);
